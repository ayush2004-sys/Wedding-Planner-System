 ...
 */
public class MuslimServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MuslimServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String insertQuery2 = "INSERT INTO muslim(firstName, lastName, contactNumber, location, weddingDate, totalBudget) VALUES (?, ?, ?, ?, ?, ?)";
...
//            connection.close();
            ...
            if (rowsAffected2> 0) {
                ...
                response.sendRedirect("Muslim.jsp?error=1");
            }
            ...
            // You can redirect to an error page or show an error message
            response.sendRedirect("Muslim.jsp?error=2");
        }
	}
