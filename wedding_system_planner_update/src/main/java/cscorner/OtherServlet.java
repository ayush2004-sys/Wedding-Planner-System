...
public class OtherServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String insertQuery4 = "INSERT INTO other(firstName, lastName, contactNumber, location, weddingDate, totalBudget) VALUES (?, ?, ?, ?, ?, ?)";



            // Create prepared statement
            PreparedStatement preparedStatement = connection.prepareStatement(insertQuery4);
...
//            connection.close();
            ...
            if (rowsAffected4> 0) {
                ...
                response.sendRedirect("Other.jsp?error=1");
            }
            ...
            // You can redirect to an error page or show an error message
            response.sendRedirect("Other.jsp?error=2");
        }
	}
